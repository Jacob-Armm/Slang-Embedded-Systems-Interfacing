...
- Switch from Firmata4j to DIOZero for the Firmata Protocol
- Add more assertions to ensure to the abract-physical association in well-formed
- Add more exmaples of SESI with and without HAMR
- Add more example devices and platforms
